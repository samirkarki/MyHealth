...
import SymptomsDetailForm from './symptoms-detail-form'
...
const SymptomsForm = () => {
  ...
  const [symptomState, setSymptomState] = useState([{ ...blankSymptom }]);
  ...
  const handleSymptomChange = e => {
    ...
    updatedSymptom[e.target.dataset.idx][e.target.className.split(" ")[0]] =
      e.target.value;
    setSymptomState(updatedSymptom);
  };

  const clearForm = () => {
    setSymptomState([{ ...blankSymptom }]);
  };
       ...
       />
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            <ClientPagination
              data={
                tableData.symptomsInfo != null ? tableData.symptomsInfo : []
              }
