      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card text-white bg-info mb-3">
            ...
            <div className="card-body">
              {dataitem.diseaseName === "0" && (
                <p className="card-text">
                  <h5>
                    तपाइले भर्नु भएको फर्मको आधार मा तपाइलाई{" "}
              ...
              {dataitem.diseaseName !== "0" && (
                <p className="card-text">
                  <h5>
                    तपाइले भर्नु भएको फर्मको आधार मा तपाइलाई कुन रोगको सम्भावना
                    देखिएन |{" "}
                  </h5>
                </p>
              )}
              ...
              <div className="alert alert-dismissible alert-info">
                <p className="mb-0">
                  ...
                  <p>
                    ...
                    मुल्यांकन मात्र हो र विशेषज्ञको सल्लाहलाइ मात्र अन्तिम
                    निस्कर्ष मान्नुहोला | तपाइको सूचना गोप्य रखिनेछ |
                  </p>
                </p>
              </div>
