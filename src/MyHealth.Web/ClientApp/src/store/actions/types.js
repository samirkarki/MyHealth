...
export const SAVE_QUESTIONS_START = 'SAVE_QUESTIONS_START'
export const SAVE_QUESTIONS_SUCCESS = 'SAVE_QUESTIONS_SUCCESS'
export const SAVE_QUESTIONS_ERROR = 'SAVE_QUESTIONS_ERROR'

export const LOAD_QUESTIONS_INITIAL_STATE = 'LOAD_QUESTIONS_INITIAL_STATE'

export const LOAD_RESULT_START = 'LOAD_RESULT_START'
